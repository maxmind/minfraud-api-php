 ...
 *   database.
 * * `BILLING_COUNTRY_NOT_FOUND` – the billing country could not be found in our
 *   database.
 ...
 *   our database.
 * * `SHIPPING_POSTAL_NOT_FOUND` – the shipping postal could not be found in our
 *   database.
 *
 * @property string $warning This field provides a human-readable explanation of
 * the warning. The description may change at any time and should not be matched
 * against.
