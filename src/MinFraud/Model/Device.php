 ...
 *
 * @property float|null $confidence This number represents our confidence that
 ...
 * @property string|null $id A UUID that MaxMind uses for the device associated
 ...
 * @property string|null $lastSeen This is the date and time of the last
