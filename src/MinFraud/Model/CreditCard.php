 ...
 *
 * @property string|null $brand The card brand, such as "Visa", "Discover",
 * "American Express", etc.
 *
 * @property string|null $country This property contains the the two letter
 ...
 *
 * @property boolean|null $isIssuedInBillingAddressCountry This property is
 ...
 * issuing the card.
 *
 * @property boolean|null $isPrepaid This property is true if the card is a
 * prepaid card.
 *
 * @property \MaxMind\MinFraud\Model\Issuer $issuer An object containing
 * information about the credit card issuer.
 *
 * @property string|null $type The card's type. The valid values are: charge,
 * credit, debit.
 */
